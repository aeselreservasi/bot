...
if (localStorage.getItem("exam") === "F10-E10J") {
  ...
  //Pernah di jepang
  document.getElementById("question4").value = "No, I have not been to Japan before";
  // Sekolah automobile?
  ...
  document.getElementById("Next").click();
  skip();
} else if (["M50-J11J", "M50-J12J", "M50-J13J", "M50-J14J", "M50-J15J", "M50-J16J", "M50-J17J", "M50-J18J", "M50-J19J", "M50-J20J"].includes(localStorage.getItem("exam"))) {
  if (cust["Tanggal Lahir"]) {
    const bulan = {
      january: "1",
      febrary: "2",
